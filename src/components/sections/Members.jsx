...
const programs = [
  ...
  },
  {
    id: '04',
    slug: 'medical',
    hindi: 'ग्रामीण स्वास्थ्य',
    tag: 'सेवा · Rural Healthcare',
    title: 'Medical Aid',
  ...
  },
  {
    ...
    slug: 'rivers',
    hindi: 'नदी संरक्षण',
    tag: 'पर्यावरण · Flagship Initiative',
    ...
    <section className="mission-page">
      ...
      {programs.map((p) => (
        ...
        >
          ...
          {/* Image column — natural height, drives row height */}
          ...
          {/* Text column — same height as image via flex stretch */}
